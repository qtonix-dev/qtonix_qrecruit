...
export const JobTypeForm = (props) => {
      ...
      useEffect(() => {
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/savejobType',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
                    if(response.data.status){
                         navigate(API.defaults.frontURL+'/jobTypes');
                      }else{
                      ...
                      <Col span={20} offset={2}>
                         ...
                         <Card>
                           <h2>Create New Type</h2>
                             <Form name="type_details" labelCol={{span: 8}} wrapperCol={{span: 16}} initialValues={{ }} onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete="off">
...
export default connect(mapStateToProps, {})(JobTypeForm)