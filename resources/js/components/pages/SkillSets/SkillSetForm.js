...
export const SkillSetForm = (props) => {
      ...
      useEffect(() => {
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/saveSkillSet',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
                    if(response.data.status){
                         navigate(API.defaults.frontURL+'/skillSets');
                      }else{
                      ...
                      <Col span={20} offset={2}>
                         ...
                         <Card>
                           <h2>Create New Skill</h2>
                             <Form name="exp_details" labelCol={{span: 8}} wrapperCol={{span: 16}} initialValues={{ }} onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete="off">
...
export default connect(mapStateToProps, {})(SkillSetForm)