...
export const DepartmentForm = (props) => {
     ...
     const verifyAccess=(section, action)=>{
      ...
      useEffect(() => {
         ...
         if(!verifyAccess('Departments','Add')){
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/saveDepartmentDetails',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
                      ...
                      <Col span={20} offset={2}>
                         ...
                         <Card>
                           <h2>Create Department</h2>
                             <Form name="department" labelCol={{span: 8}} wrapperCol={{span: 16}} initialValues={{ }} onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete="off">
