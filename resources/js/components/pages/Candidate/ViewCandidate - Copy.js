...
import { CaretRightOutlined,ExclamationCircleOutlined, FormOutlined, UploadOutlined,PlusOutlined,InboxOutlined,DeleteOutlined,StarFilled,DownloadOutlined,StarOutlined,EditOutlined,FileDoneOutlined,FileProtectOutlined, EditFilled,CalendarOutlined,UserSwitchOutlined} from '@ant-design/icons';
      ...
      const notesConfig = {
              ...
              content: (
                <><Form form={form}>
                      <Row>
                        <Col  span={24}>
                          <Form.Item name="notes" label="Notes" labelCol={{span: 4}} wrapperCol={{span: 20}} rules={[{ required: true, message: 'Notes is required!' }]}>
                        ...
                        <Col span={22} offset={1}>
                            ...
                            <Tabs defaultActiveKey="1">
                                <Tabs.TabPane tab="Overview" key="1">
                                    ...
                                    <Collapse defaultActiveKey={['0']} style={{marginTop:'2%'}}>
