...
export const CandidateSourceForm = (props) => {
      ...
      useEffect(() => {
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/saveCandidateSource',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
                ...
                <Body>
                  <Row>
                      <Col span={20} offset={2}>
                         ...
                         <Card>
                           <h2>Create New Candidate Source</h2>
...
export default connect(mapStateToProps, {})(CandidateSourceForm)