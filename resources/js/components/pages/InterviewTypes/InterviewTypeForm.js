...
export const InterviewTypeForm = (props) => {
     ...
     const verifyAccess=(section, action)=>{
      ...
      useEffect(() => {
         ...
         if(!verifyAccess('Interview Types','Add')){
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/saveInterviewTypeDetails',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
...
export default connect(mapStateToProps, {})(InterviewTypeForm)