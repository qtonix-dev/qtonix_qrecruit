...
export const NoteTypeForm = (props) => {
     ...
     const verifyAccess=(section, action)=>{
      ...
      useEffect(() => {
         ...
         if(!verifyAccess('Note Types','Add')){
       ...
       const onFinish = (formData) => {
           const hide = message.loading('Loading', 0);
              API.post('/saveNoteTypeDetails',formData)
                  .then(response=>{
                     setTimeout(hide, 0);
...
export default connect(mapStateToProps, {})(NoteTypeForm)